...
current registry contains 145 tools. Every call is attributed to the user
whose token authenticates the connection.
...
| Deploys and stacks | `deploy_get`, `deploy_list`, `deploy_list_by_service`, `deploy_list_by_status`, `deploy_cancel`, `service_list`, `machine_import`, `stack_create`, `stack_deploy`, `stack_get`, `stack_list`, `stack_update`, `stack_delete`, `stack_rollback` |
