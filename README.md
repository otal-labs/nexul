...
| Deploys | Coolify, Heroku, Render |
| CI runners | GitHub Actions self-hosted runners, Jenkins |
...
```
Docs (ideas land here; run the /wayfinder play when one is not clear yet, or /grill-with-docs to clear it)
