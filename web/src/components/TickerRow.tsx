...
// One ticker row: listed up front with why it's needed, then a spinner while its request runs, a tick, or a cross (or a
// warning for an advisory check) with the reason.
